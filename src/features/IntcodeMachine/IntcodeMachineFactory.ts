...
import { day2, day5, day7} from './programs';
...
import createPassthroughInput, { MonitorFunction } from './input-generators/passthrough';

let instanceId = 0;

export type IntcodeMachine = [
    IntcodeRunner,
    Debugger,
]
...
const createStub = (): IntcodeMachine => {
    ...
    const runner = intcodeRunner(program, input.generator(), debug);
    return [runner, debug];
}
