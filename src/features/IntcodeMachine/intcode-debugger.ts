import { ParameterModes, IntcodeProgram, ProgramCounter, OPCODE, MODE, PARAM } from './intcode-runner';
...
export type UpdateCallback = (update: DebugStateUpdate, debug?: Debugger) => void;
...
class Debugger {
    ...
    update() {
        this.externalObservers.forEach(f => f({
            pc: this._pc,
            op: this._op,
            modes: this._modes,
